...
(function() {
    ...
    window.addEventListener('resize', checkDevice);
        ...
        const games = [
            ...
            { id: 3, name: "Quiz Duel", category: "action", mode: "multiplayer", icon: "➗", gradient: "linear-gradient(135deg, #f59e0b, #d97706)", rating: 4.7, plays: "15.1K", badge: "new", desc: "Uji kemampuan menghitungmu!", url: "games/duel_quiz/index.html", image: "assets/images/quiz_duel.jpeg" },
            { id: 4, name: "Rhythm Hero", category: "arcade", mode: "singleplayer", icon: "🎹", gradient: "linear-gradient(135deg, #06b6d4, #0891b2)", rating: 4.3, plays: "22.0K", badge: "hot", desc: "Mainkan musik dengan mengetuk irama!", url: "games/rhythm_hero/index.html", image: "assets/images/rhythm_hero.jpeg" },
            ...
            { id: 7, name: "Space Shooter", category: "action", mode: "singleplayer", icon: "👽", gradient: "linear-gradient(135deg, #8b5cf6, #7c3aed)", rating: 4.6, plays: "9.8K", badge: "hot", desc: "Pertahankan galaksi dari invasi alien!", url: "games/space_shooter/index.html", image: "assets/images/space_shooter.jpeg" },
            ...
            { id: 10, name: "Mine sweeper", category: "Strategy", mode: "singleplayer", icon: "💣", gradient: "linear-gradient(135deg, #f59e0b, #d97706)", rating: 4.5, plays: "11.2K", badge: "New", desc: "Hindari ranjau dan selamatkan dirimu!", url: "games/mine_sweeper/index.html", image: "assets/images/mine_sweeper.jpeg" },
            { id: 11, name: "Photo Puzzle", category: "strategy", mode: "singleplayer", icon: "🧩", gradient: "linear-gradient(135deg, #64748b, #475569)", rating: 4.5, plays: "6.1K", badge: "new", desc: "Upload foto dan susun kembali foto mu!", url: "games/photo_puzzle/index.html", image: "assets/images/photo_puzzle.jpeg" },
            { id: 12, name: "Stack Tower", category: "strategy", mode: "singleplayer", icon: "🟰", gradient: "linear-gradient(135deg, #22c55e, #16a34a)", rating: 4.7, plays: "14.8K", badge: "hot", desc: "tumpuk blok-bloknya sebanyak mungkin!", url: "games/stack_tower/index.html", image: "assets/images/stack_tower.jpeg" },
            { id: 13, name: "Find The Ball", category: "arcade", mode: "singleplayer", icon: "🏐", gradient: "linear-gradient(135deg, #3b82f6, #2563eb)", rating: 4.6, plays: "10.5K", badge: "popular", desc: "Temukan bola yang tersembunyi!", url: "games/find_the_ball/index.html", image: "assets/images/find_the_ball.jpeg" },
            { id: 14, name: "Fishing Master", category: "strategy", mode: "singleplayer", icon: "🎣", gradient: "linear-gradient(135deg, #8b5cf6, #7c3aed)", rating: 4.8, plays: "13.2K", badge: "hot", desc: "Jadilah master memancing!", url: "games/fishing_master/index.html", image: "assets/images/fishing_master.jpeg" },
            { id: 15, name: "Penalty Shootout", category: "strategy", mode: "singleplayer", icon: "⚽", gradient: "linear-gradient(135deg, #f59e0b, #d97706)", rating: 4.4, plays: "9.7K", badge: "new", desc: "Jadi penendang penalti terbaik!", url: "games/penalty_shootout/index.html", image: "assets/images/penalty_shootout.jpeg" },
            { id: 16, name: "Blackjack Mobile", category: "strategy", mode: "singleplayer", icon: "♠️", gradient: "linear-gradient(135deg, #10b981, #059669)", rating: 4.5, plays: "8.9K", badge: "new", desc: "Kejar angka 21 tidak lebih tidak kurang!", url: "games/blackjack_mobile/index.html", image: "assets/images/blackjack_mobile.jpeg" },
            { id: 17, name: "UNO Mobile", category: "strategy", mode: "singleplayer", icon: "🎴", gradient: "linear-gradient(135deg, #ec4899, #db2777)", rating: 4.6, plays: "12.4K", badge: "hot", desc: "Habiskan kartumu dan katakan UNO!", url: "games/uno_mobile/index.html", image: "assets/images/uno_mobile.jpeg" },
            { id: 18, name: "Sudoku Mobile", category: "strategy", mode: "singleplayer", icon: "2️⃣", gradient: "linear-gradient(135deg, #3b82f6, #2563eb)", rating: 4.7, plays: "11.8K", badge: "popular", desc: "Selesaikan puzzle Sudoku! (1-9)", url: "games/sudoku_mobile/index.html", image: "assets/images/sudoku_mobile.jpeg" },
            { id: 19, name: "2048", category: "strategy", mode: "singleplayer", icon: "2️⃣0️⃣4️⃣8️⃣", gradient: "linear-gradient(135deg, #f97316, #ea580c)", rating: 4.5, plays: "9.3K", badge: "new", desc: "Gabungkan angka-angka untuk mencapai 2048!", url: "games/2048_mobile/index.html", image: "assets/images/2048_mobile.jpeg" },
