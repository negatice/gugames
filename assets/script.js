...
(function() {
    ...
    window.addEventListener('resize', checkDevice);
        ...
        const games = [
            ...
            { id: 20, name: "Pinball Mobile", category: "Arcade", mode: "singleplayer", icon: "💥", gradient: "linear-gradient(135deg, #22c55e, #16a34a)", rating: 4.7, plays: "14.8K", badge: "hot", desc: "Pantulkan bola dengan flipper!", url: "games/pinball_mobile/index.html", image: "assets/images/pinball_mobile.jpeg" },
            { id: 21, name: "Endless Traffic", category: "Arcade", mode: "singleplayer", icon: "🚗", gradient: "linear-gradient(135deg, #3b82f6, #2563eb)", rating: 4.8, plays: "16.5K", badge: "New", desc: "Jadilah pengemudi yang handal!", url: "games/endless_traffic/index.html", image: "assets/images/endless_traffic.jpeg" },
            { id: 22, name: "Solitaire Mobile", category: "Strategy", mode: "singleplayer", icon: "♣️", gradient: "linear-gradient(135deg, #8b5cf6, #7c3aed)", rating: 4.6, plays: "12.0K", badge: "New", desc: "Mainkan solitaire di perangkat mobile!", url: "games/solitaire_mobile/index.html", image: "assets/images/solitaire_mobile.jpeg" },
            { id: 23, name: "Mine sweeper", category: "Strategy", mode: "singleplayer", icon: "💣", gradient: "linear-gradient(135deg, #f59e0b, #d97706)", rating: 4.5, plays: "11.2K", badge: "New", desc: "Hindari ranjau dan selamatkan dirimu!", url: "games/mine_sweeper/index.html", image: "assets/images/mine_sweeper.jpeg" }
        ];
        // ============================================
        // STATE
        // ============================================
